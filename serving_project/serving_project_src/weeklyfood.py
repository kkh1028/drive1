...
class Ui_Today(object):
    ...
    def setupUi(self, Today):
        ...
        # 스크롤링 라벨 추가
        self.label = ScrollingLabel("🍚 천원의 아침밥 식당의 주간 급식 메뉴를 확인하세요! 🍚", Today)
    ...
    def load_menu_data(self):
        ...
        if menu_data:
            ...
            print("급식 메뉴 데이터를 가져오는 데 실패했습니다.")

    def retranslateUi(self, Today):
        Today.setWindowTitle(QCoreApplication.translate("Today", u"주간 급식 메뉴", None))
        self.label.setText(QCoreApplication.translate("Today", u"🍚 천원의 아침밥 식당의 주간 급식 메뉴를 확인하세요! 🍚", None))


class TodayWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.ui = Ui_Today()
